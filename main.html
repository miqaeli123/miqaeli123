          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              ...
              <li class="nav-item active">
                <a class="nav-link text-warning" href="contact.html">Contact Us<span class="sr-only"></span></a>
              </li>
              <li class="nav-item">
...
<div class="container">
    <div class="contactinfo">
        <div>
            ...
            <ul class="info">
                <li>
                    <span><img src="./image/location-pin.png"></span>
                    <span>nutsubidze 3 plato
                         chxikvadzis 31<br>
                         tbilisi<br>         
                    </span>
                </li>
                <li>
                    ...
                    <span>Lorem@ipsum.com      
                    </span>
                </li>
                <li>
                    <span><img src="./image/phone-call.png"></span>
                    <span>310-386-1623
                </li>
            </ul>
            <ul class="sci">
                ...
                <li><a href="#"><img src="./image/5.png"></a></li>
            </ul>
        </div>
    </div>
    <div class="contactForm">
        ...
        <div class="formBox">
            ...
            <div class="inputbox w50">
                <input type="text" name="" placeholder="Number" required>
